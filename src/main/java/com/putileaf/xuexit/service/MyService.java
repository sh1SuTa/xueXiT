...
//        formData.add("uuid", "c5804a0df482456d8077942b87b098d7");//10.1修改
        formData.add("uuid", "c03b5d75ddf0475d8a9ff3b695fef7dc");//2026.2.28修改
    ...
    //无formIdValueData请求
    public Mono<String> sendFormDataNoFormIdValueData(String checkCode,String User_Cookie) {
        // 创建表单数据
        MultiValueMap<String, String> formData = new LinkedMultiValueMap<>();
        formData.add("formId", "819284");  // 添加表单字段
        formData.add("version", "1");
        ...
        formData.add("submitVersion", "1759140144000");
